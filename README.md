# Eyekart API client library

Allows asynchronous requests to Eyekart REST API and get results with native Promise or async/await. Work on browser and server.

Client include:
- Eyekart API
- Eyekart AJAX API
- Eyekart Web Store API


Install with:

```
npm install eyekart-client
```
...
```javascript
import EyekartClient from 'eyekart-client';

const api = new EyekartClient({
